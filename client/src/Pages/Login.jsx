...
import LoginImage from "../assets/login.webp"; // Assuming you have a login image in your assets
    ...
    return (<div className='flex'>
        <div className='w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
            <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-8 rounded-lg shadow-sm'>
                ...
                <p className='text-center mb-6 capitalize'>Please enter your credentials to login.</p>
                <div className='mb-4'>
                ...
                <p className='text-sm mt-6 text-center'>Don't Have An Account?  <Link to="/register" className='text-blue-500'>Sign Up</Link></p>
            </form>
        </div>
        <div className='hidden md:block bg-gray-800 w-1/2'>
            <div className='h-full flex justify-center items-center'>
                <img src={LoginImage} alt="Login" className='h-[700px] w-full object-cover' />
            </div>
            </div>
    </div>
    )
